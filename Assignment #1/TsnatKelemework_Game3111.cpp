...
void ShapesApp::BuildRenderItems()
{
    ...
    CreateItem("box", XMMatrixScaling(0.5f, 12.5f, 17.35f), XMMatrixTranslation(9.0f, 3.2f, 0.0f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);//right
    objCBIndex++;
    CreateItem("box", XMMatrixScaling(0.5f, 12.5f, 17.35f), XMMatrixTranslation(-9.0f, 3.2f, 0.0f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);//left 
    objCBIndex++;
    CreateItem("box", XMMatrixScaling(12.35f, 12.5f, 0.5f), XMMatrixTranslation(0.0f, 3.2f, 13.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);// back 
    objCBIndex++;


    CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-5.0f, 1.8f, 9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);//Back
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-3.0f, 1.8f, 9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);//
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-1.0f, 1.8f, 9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);//
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(3.0f, 1.8f, 9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);//
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(5.0f, 1.8f, 9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);//
    objCBIndex++;                                         
                                                          
                                                          
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-5.0f, 1.8f, -9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);// Front
    objCBIndex++;                                         
    CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-3.0f, 1.8f, -9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);//
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-1.0f, 1.8f, -9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);// 
	...
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(7.0f, 1.8f, -9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);// Right 
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(7.0f, 1.8f, -9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(7.0f, 1.8f, -7.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(7.0f, 1.8f, -5.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(7.0f, 1.8f, -3.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(7.0f, 1.8f, -1.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(7.0f, 1.8f, 1.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex); 
    objCBIndex++;                                         
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(7.0f, 1.8f, 3.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
	...
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-7, 1.8f, -9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);// Left 
    objCBIndex++;                                                                           
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-7, 1.8f, -9.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                                                           
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-7, 1.8f, -7.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                                                           
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-7, 1.8f, -5.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                                                           
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-7, 1.8f, -3.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                                                           
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-7, 1.8f, -1.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;                                                                           
	CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-7, 1.8f, 1.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex); 
    objCBIndex++;                                                                           
    CreateItem("cylinder", XMMatrixScaling(1.0f, 2.2f, 1.0f), XMMatrixTranslation(-7, 1.8f, 3.5f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    ...
    CreateItem("pyramid", XMMatrixScaling(15.0f, 7.0f, 20.0f), XMMatrixTranslation(0.0f, 8.7f, 0.0f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);// Roof
    objCBIndex++;


    CreateItem("diamond", XMMatrixScaling(1.0f, 1.0f, 1.0f), XMMatrixTranslation(6.0f, 1.0f, 6.0f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);// diamon 
    objCBIndex++;

    CreateItem("triangularPrism", XMMatrixScaling(1.0f, 1.0f, 1.0f), XMMatrixTranslation(8.0f, 6.0f, 0.0f), XMMatrixRotationRollPitchYaw(XM_PIDIV2, XM_PIDIV2, 0.f), objCBIndex);
	objCBIndex++;

    CreateItem("torus", XMMatrixScaling(1.0f, 1.0f, 1.0f), XMMatrixTranslation(0.0f, 5.0f, 0.0f), XMMatrixRotationRollPitchYaw(0.0f, 0.0f, 0.0f), objCBIndex);
    objCBIndex++;
   
    CreateItem("cone", XMMatrixScaling(1.0f, 2.0f, 1.0f), XMMatrixTranslation(-5.0f, 1.0f, 6.0f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex);
    objCBIndex++;
