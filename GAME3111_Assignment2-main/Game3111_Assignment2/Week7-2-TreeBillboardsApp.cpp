...
void TreeBillboardsApp::BuildRenderItems()
{
	...
	CreateItem("pyramid", XMMatrixScaling(15.0f, 7.0f, 20.0f), XMMatrixTranslation(0.0f, 16.7f, 0.0f), XMMatrixRotationRollPitchYaw(0.f, 0.f, 0.f), objCBIndex, "pyramid");// Roof
	objCBIndex++;
